...
from conf.models import District, Region, County, SubCounty, Village, Parish, PaymentMethod, MessageTemplates
...
class RegionForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['districts'].widget.attrs.update({'class': "selec_adv_1"})
