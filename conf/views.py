...
from conf.models import District, Region, County, SubCounty, Parish, Village, PaymentMethod, MessageTemplates
from conf.forms import DistrictForm, CountyForm, SubCountyForm, VillageForm, PaymentMethodForm, UploadLocation,\
MessageTemplatesForm, RegionForm
...
class CountyDeleteView(ExtraContext, DeleteView):
    model = County
    success_url = reverse_lazy('conf:county_list')
    template_name='confirm_delete.html'
    ...
    def get_context_data(self, **kwargs):
        #
        context = super(CountyDeleteView, self).get_context_data(**kwargs)
        #
...
class SubCountyDeleteView(ExtraContext, DeleteView):
    model = SubCounty
    success_url = reverse_lazy('conf:subcounty_list')
    template_name='confirm_delete.html'
    ...
    def get_context_data(self, **kwargs):
        #
        context = super(SubCountyDeleteView, self).get_context_data(**kwargs)
        #
