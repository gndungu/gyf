    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_type', models.CharField(choices=[['LOAN', 'LOAN'], ['CASH', 'CASH'], ['MOBILE_MONEY', 'MOBILE_MONEY']], default='LOAN', max_length=120)),
                ...
                ('approval_reject_reason', models.CharField(blank=True, max_length=120, null=True)),
                ('processing_start_date', models.DateTimeField(blank=True, null=True)),
                ('processing_reject_reason', models.CharField(blank=True, max_length=120, null=True)),
