            ...
            if serializer.is_valid():
                ...
                #    cooperative = True
                    ...
                    if q_token.exists():
                        ...
                        farmer_group = FarmerGroup.objects.values('id', 'name', 'code').all()
...
class MemberEndpoint(APIView):
    ...
    def post(self, request, format=None):
        ...
        # if request.data.get('farmer_group'):
        #     request.data['farmer_group'] = FarmerGroup.objects.get(pk=request.data.get('farmer_group'))
        if mem.count() > 0:
                ...
                with transaction.atomic():
                    ...
                    if mem.count() < 1: 
                        ...
                        if mes:
                            ...
                            #         message = message.replace('<COOPERATIVE>', "FG")
...
class MemberList(APIView):
    ...
    def post(self, request, member=None, format=None):
        ...
        if farmer_group == 'all':
            ...
            members = CooperativeMember.objects.filter(farmer_group=farmer_group).order_by('-surname')
