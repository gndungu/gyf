...
urlpatterns = [
      ...
      url(r'item/upload/$', ItemUploadView.as_view(), name='item_upload'),
      ...
      url(r'supplier/user/create/(?P<supplier>[\w]+)/(?P<pk>[\w]+)/$', SupplierUserUpdateView.as_view(), name="supplier_user_create"),
