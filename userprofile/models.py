...
class Profile(models.Model):
    ...
    def is_union(self):
        if self.access_level:
            if self.access_level.name.upper() == "UNION" or self.access_level.name.upper() == "TERRITORY" or self.access_level.name.upper() == "OFFICER":
                return True
    ...
    def is_agent(self):
        if self.access_level:
            if self.access_level.name.upper() == "AGENT":
                return True
        if self.user.is_superuser:
            return True
        return False
    ...
    def is_viewer(self):
        if self.access_level:
            if self.access_level.name.upper() == "VIEW":
                return True
        if self.user.is_superuser:
            return True
        return False
    ...
    def is_union_admin(self):
        if self.access_level.name.upper() == "UNION" or  self.access_level.name.upper() == "TERRITORY"  or self.user.is_superuser:
            return True
        return False
